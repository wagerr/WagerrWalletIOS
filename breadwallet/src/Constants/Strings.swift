...
enum S {
    ...
    enum FeeSelector {
        ...
        static let economyTime = NSLocalizedString("FeeSelector.economyTime", value: "10-20 minutes", comment: "E.g. [This transaction is predicted to complete in] 1-24 hours")
